...
OUT_DIR = ROOT / "outputs" / "videopose3d_mpi_clip_fullseq"
...
# VideoPose3D receptive field is 243, so pad by 121 on each side.
pad = 121
padded = np.pad(h36m_2d_norm, ((pad, pad), (0, 0), (0, 0)), mode="edge")
...
out_path = OUT_DIR / "video0_first243_videopose3d_fullseq.npz"
np.savez(
    out_path,
    pred_3d=pred_3d,
